...
// // === Tipos simplificados (ajusta a tus modelos reales si quieres) ===
// type Tarea = {
//   id: string;
//   titulo: string;
...
// // === DEMO DATA (reemplaza luego por lo que tengas guardado) ===
// const tareasDemo: Tarea[] = [
//   {
//     id: "t1",
//     titulo: "Entregar reporte de investigación",
//     fecha: "2025-11-05",
//     completada: true,
//   },
//   {
//     id: "t2",
//     titulo: "Estudiar para examen de BD",
//     fecha: "2025-11-12",
//     completada: false,
//   },
//   {
//     id: "t3",
//     titulo: "Proyecto de metaheurísticas",
//     fecha: "2025-11-20",
//     completada: true,
//   },
// ];
...
//   {
//     id: "e1",
//     titulo: "Cita con tutor académico",
//     fecha: "2025-11-03",
//     hora: "10:00",
//   },
//   { id: "e2", titulo: "Consulta médica", fecha: "2025-11-15", hora: "16:30" },
//   { id: "e3", titulo: "Junta de proyecto", fecha: "2025-11-21", hora: "13:00" },
// ];

// const comprasDemo: Compra[] = [
//   {
//     id: "c1",
//     fecha: "2025-11-02",
//     categoria: "Comida",
//     descripcion: "Comida en la uni",
//     monto: 85,
//   },
//   {
//     id: "c2",
...
// function isSameMonth(iso: string, year: number, month0: number) {
//   if (!iso) return false;
...
//     () => tareasDemo.filter((t) => isSameMonth(t.fecha, year, month0)),
//     [year, month0]
//   );
//   const eventosMes = useMemo(
//     () => eventosDemo.filter((e) => isSameMonth(e.fecha, year, month0)),
//     [year, month0]
//   );
//   const comprasMes = useMemo(
//     () => comprasDemo.filter((c) => isSameMonth(c.fecha, year, month0)),
//     [year, month0]
//   );
...
//   const totalGasto = comprasMes.reduce((acc, c) => acc + c.monto, 0);
...
//               <Text style={styles.cardSubtitle}>
//                 Citas y actividades que tienes agendadas.
//               </Text>
//             </View>
//           </View>
...
//                       </Text>
//                     </Text>
//                     <Text style={[styles.modalItemText, { marginTop: 4 }]}>
...
// /* =======================================================
//    🔥 FUNCIONES DE FECHA Y VALIDACIÓN
//    ======================================================= */
...
// // EVENTOS: validación estricta YYYY-MM-DD
// function getEventoDate(e: StoredEvento): Date | null {
//   if (!e.fecha) return null;
//   const m = e.fecha.match(/^(\d{4})-(\d{2})-(\d{2})$/);
//   if (!m) return null;
...
// // COMPRAS — fecha derivada del ID numérico
// function compraFecha(c: StoredCompra): Date {
//   const ts = Number(c.id);
//   return Number.isFinite(ts) ? new Date(ts) : new Date(0);
// }
...
// function isSameMonthDate(d: Date | null, y: number, m0: number) {
//   return !!d && d.getFullYear() === y && d.getMonth() === m0;
// }
...
//         setCompras(cp || []);
//       } catch (e) {
//         console.log("[reportes] error carga local", e);
//       }
//     })();
//   }, [userId]);

//   /* =======================================================
//      🔥 2. SNAPSHOT FIRESTORE — SOLO TAREAS 🟢 (Fix del bug)
//      ======================================================= */
...
//       colRef,
//       async (snapshot) => {
//         const cloud: StoredTask[] = snapshot.docs.map((d) => {
//           const data = d.data() as any;

//           // Convertir id a number igual que en TareasScreen
//           const id =
...
//       },
//       (err) => console.log("[reportes snapshot tareas] error:", err)
//     );
...
//     () =>
//       eventos.filter((e) => {
//         const dt = getEventoDate(e);
//         return dt && isSameMonthDate(dt, year, month0);
//       }),
//     [eventos, year, month0]
//   );
...
//       acc[c.categoria] = (acc[c.categoria] || 0) + subtotal;
//       return acc;
//     },
//     {}
//   );
