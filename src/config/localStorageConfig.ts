...
// // Tipo base para medicamentos guardados
...
// /**
//  * Genera la llave de AsyncStorage en función del usuario.
//  * Si uid es null/undefined, usamos "guest".
//  */
...
// /**
//  * Carga los medicamentos del usuario indicado.
//  */
// export async function loadMeds(uid?: string | null): Promise<StoredMed[]> {
//   try {
//     const key = medsKeyForUser(uid);
//     const raw = await AsyncStorage.getItem(key);
//     if (!raw) return [];
//     const parsed = JSON.parse(raw);
//     if (Array.isArray(parsed)) return parsed as StoredMed[];
//     return [];
//   } catch (e) {
...
// /**
//  * Guarda los medicamentos para el usuario indicado.
//  */
...
//   id: number; // usamos number porque en tu pantalla usas Date.now()
//   titulo: string;
...
// /**
//  * Carga las tareas del usuario indicado desde AsyncStorage.
//  */
// export async function loadTasks(uid?: string | null): Promise<StoredTask[]> {
//   try {
//     const key = tasksKeyForUser(uid);
//     const raw = await AsyncStorage.getItem(key);
//     if (!raw) return [];
//     const parsed = JSON.parse(raw);
...
// /**
//  * Guarda las tareas del usuario indicado en AsyncStorage.
//  */
...
//   compras: "compras_data", // 🔥 NUEVO
//   lastSync: "last_sync_timestamp",
// };

// // ===========================
// // COMPRAS — Offline Storage
// // Igual que Medicamentos
// // ===========================
...
// const COMPRAS_KEY = "compras_data";

// // Cargar compras del almacenamiento local
...
// const EVENTOS_KEY = "eventos_data";
...
// // ===========================
// // AUTH — Offline Storage
// // ===========================

// export type StoredUser = {
//   id: string; // uuid local
//   email: string;
//   password: string; // luego se puede hashear
//   nombre: string;
//   synced: boolean; // ya está en Firebase?
//   deleted?: boolean; // marcado para NO sincronizar
// };
